        ...
        <div className="max-w-2xl mx-auto px-6">
          ...
          {estado !== "success" && (
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-stone-200 p-6 sm:p-8 shadow-sm">
              ...
              {/* Selector de tipo - CORREGIDO PARA MOBILE */}
              <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6">
                ...
                >
                  ...
                  <h3 className={`font-semibold text-sm sm:text-base leading-tight mb-1 ${esServicio ? "text-emerald-700" : "text-stone-800"}`}>
                ...
                >
                  ...
                  <h3 className={`font-semibold text-sm sm:text-base leading-tight mb-1 ${esNegocio ? "text-purple-700" : "text-stone-800"}`}>
                    Negocio
                  </h3>
                  <p className="text-xs sm:text-sm text-stone-500 leading-tight">
